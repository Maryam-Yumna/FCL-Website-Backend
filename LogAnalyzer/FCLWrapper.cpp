...
std::string  FCLWrapper::GetLogLDALResult(const char *defFilePath ,const char *query,const char *json ) {
    LDAL_Wrapper ldalWrapper;
    return  ldalWrapper.GetLOGLDALResult(defFilePath,query,json);
