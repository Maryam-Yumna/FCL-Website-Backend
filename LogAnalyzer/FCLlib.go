...
extern swig_type_17 _wrap_FCLWrapper_GetLogLDALResult_FCLlib_1ee54ad49562e6e8(uintptr_t arg1, swig_type_18 arg2, swig_type_19 arg3, swig_type_20 arg4);
extern swig_type_21 _wrap_FCLWrapper_GetOTPResult_FCLlib_1ee54ad49562e6e8(uintptr_t arg1, swig_type_22 arg2);
extern swig_type_23 _wrap_FCLWrapper_GetBuildResult_FCLlib_1ee54ad49562e6e8(uintptr_t arg1, swig_type_24 arg2);
...
func (arg1 SwigcptrFCLWrapper) GetLogLDALResult(arg2 string, arg3 string, arg4 string) (_swig_ret string) {
	var swig_r string
	_swig_i_0 := arg1
	_swig_i_1 := arg2
	_swig_i_2 := arg3
	_swig_i_3 := arg4
	swig_r_p := C._wrap_FCLWrapper_GetLogLDALResult_FCLlib_1ee54ad49562e6e8(C.uintptr_t(_swig_i_0), *(*C.swig_type_18)(unsafe.Pointer(&_swig_i_1)), *(*C.swig_type_19)(unsafe.Pointer(&_swig_i_2)), *(*C.swig_type_20)(unsafe.Pointer(&_swig_i_3)))
	swig_r = *(*string)(unsafe.Pointer(&swig_r_p))
	if Swig_escape_always_false {
		Swig_escape_val = arg2
	}
...
func (arg1 SwigcptrFCLWrapper) GetOTPResult(arg2 string) (_swig_ret string) {
	...
	_swig_i_0 := arg1
	_swig_i_1 := arg2
	swig_r_p := C._wrap_FCLWrapper_GetOTPResult_FCLlib_1ee54ad49562e6e8(C.uintptr_t(_swig_i_0), *(*C.swig_type_22)(unsafe.Pointer(&_swig_i_1)))
	swig_r = *(*string)(unsafe.Pointer(&swig_r_p))
	if Swig_escape_always_false {
		Swig_escape_val = arg2
	}
...
func (arg1 SwigcptrFCLWrapper) GetBuildResult(arg2 string) (_swig_ret string) {
	...
	_swig_i_0 := arg1
	_swig_i_1 := arg2
	swig_r_p := C._wrap_FCLWrapper_GetBuildResult_FCLlib_1ee54ad49562e6e8(C.uintptr_t(_swig_i_0), *(*C.swig_type_24)(unsafe.Pointer(&_swig_i_1)))
	swig_r = *(*string)(unsafe.Pointer(&swig_r_p))
	if Swig_escape_always_false {
		Swig_escape_val = arg2
	}
...
type FCLWrapper interface {
	...
	GetLogLDALResult(arg2 string, arg3 string, arg4 string) (_swig_ret string)
